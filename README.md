...
dotnet anchorgen -i target/idl/tiny_adventure.json -o target/idl/TinyAdventure.cs
```

(Replace tiny_adventure with the name of your program)
...
useEffect(() => {
    ...
    const [pda] = PublicKey.findProgramAddressSync(
        ...
        publicKey.toBuffer()],
        new PublicKey(TinyAdventure_PROGRAM_ID)
      );
    try {
